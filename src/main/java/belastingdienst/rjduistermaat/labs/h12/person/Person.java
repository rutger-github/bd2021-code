...
import belastingdienst.rjduistermaat.labs.h12.MyAnnotation;
import belastingdienst.rjduistermaat.labs.h12.MyAnnotation2;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.Objects;

@MyAnnotation("class person overwrite default")
...
//    }
    ...
    private class HistoryRecord {
        ...
        @MyAnnotation("Inner class 2")
        private class HistoryRecord2 {
            private String description;
